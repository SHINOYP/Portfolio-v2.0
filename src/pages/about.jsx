...
export default function About(){
    ...
    >
        <section className=" flex  flex-col md:flex-row justify-between mx-auto  width_limit" >
            <div className="">
                    <h1 className=" md:flex-col text-xl font-bold mx-3 my-6"> who am i?</h1>
        ...
        <section className=" mx-auto  width_limit " >
            <div className=" flex justify-between ml-4  mt-6  ">
                    <div>
                        <h1 className="md:text-2xl text-lg font-semibold " >#Contacts<span > -----------</span> </h1>
                    </div>
            </div>
            <div className="flex  flex-col md:flex-row justify-between mx-auto" >
                ...
                <div className="md:m-10  m-4">
                    <div className=" w-64 h-32 border  md:m-2 pic hide " data-aos="zoom-in" > 
                        <p className=" font-bold mx-4 text-white text-sm md:text-base">Message me here</p>
                        <img src={Gmail} className="m-2 inline hover:text-white"  alt=""></img><a href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=shinoyshinoo@gmail.com"className="hover:text-white">shinoyshinoo@gmail.com </a>
                        <img src={Disc} className="m-2 inline "  alt=""></img><a href="https://discord.com/login" className="hover:text-white">falcon #0900</a>
                    </div>
                </div>   
            </div> 
        </section>       
